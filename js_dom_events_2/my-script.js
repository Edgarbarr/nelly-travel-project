...
*/
const quoteButton = document.getElementById("random_quote_btn");
const quoteContainer = document.getElementById("quotes_container");
quoteContainer.style.display = "flex";

const getQuoteElement = () => {
  let para = document.createElement("p");
  para.innerHTML = pickRandomQuote(inspirationalQuotes);
  para.style.backgroundColor = getRandomHexColor();
  return para;
};

quoteButton.onclick = () => quoteContainer.appendChild(getQuoteElement());
